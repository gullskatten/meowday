...
const k_tag_dialog_title = 'tag.dialog.title';
const k_tag_dialog_suggest_label = 'tag.dialog.suggest.label';
const k_tag_suggestion_1 = 'tag.suggestion.option.1';
const k_tag_suggestion_2 = 'tag.suggestion.option.2';
const k_tag_suggestion_3 = 'tag.suggestion.option.3';
const k_tag_suggestion_4 = 'tag.suggestion.option.4';
...
class _TagDialogState extends State<TagDialog> {
  List<Tag> _suggestions = [
    Tag('id1', k_tag_suggestion_1),
    Tag('id2', k_tag_suggestion_2),
    Tag('id3', k_tag_suggestion_3),
    Tag('id4', k_tag_suggestion_4),
  ];
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      ...
      content: Column(
        ...
        children: [
          StyledText(
            Loc.of(context).t(k_tag_dialog_title),
              ...
              Expanded(
                child: TextField(
                    ...
                    decoration: InputDecoration(
                      hintText: context.select((CalendarProvider value) => DateFormat("EEEE", Loc.of(context).locale.languageCode)
          ...
          Align(
            ...
            child: StyledText(
              Loc.of(context).t(k_tag_dialog_suggest_label),
          ...
          Container(
            ...
            child: ListView(
              ...
              children: _suggestions.map((e) {
                String tag = Loc.of(context).t(e.tag);

                return FlatButton(
                  padding: EdgeInsets.symmetric(
                      vertical: kSpacingTiny, horizontal: kSpacingSmall),
                  child: StyledText(
                    '#' + tag,
